...
public class WoodSource extends GenericResource {
    ...
    public static void repopulate() {
        ...
        for (int i = 0; i < popIncrease; i++) {
            new WoodSource(AssetLoading.smallTree, TileHandler.getRandRegionTile(TileHandler.getSize(AssetLoading.smallTree), AssetLoading.mountainTileFull, AssetLoading.desertTileFull));
        }
    }
